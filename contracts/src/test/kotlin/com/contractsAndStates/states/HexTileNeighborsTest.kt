...
class HexTileNeighborsTest {
    ...
    fun `indexOf by tile index is correct`() {
        val neighbors = HexTileNeighbors(listOf(2, null, null, 0, 5, 12).makeNeighbors())
        assertEquals(0, neighbors.indexOf(HexTileIndex(2)))
        assertEquals(3, neighbors.indexOf(HexTileIndex(0)))
        assertEquals(4, neighbors.indexOf(HexTileIndex(5)))
        assertEquals(5, neighbors.indexOf(HexTileIndex(12)))
    }
