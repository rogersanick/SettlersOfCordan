...
fun main(args: Array<String>) {
    ...
    driver(DriverParameters(cordappsForAllNodes = listOf(TestCordapp.findCordapp("com.statesAndContracts"), TestCordapp.findCordapp( "com.flows")), startNodesInProcess = true, waitForAllNodesToFinish = true)) {
