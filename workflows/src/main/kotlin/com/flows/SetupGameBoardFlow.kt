...
class SetupGameBoardFlow(val p1: Party, val p2: Party, val p3: Party, val p4: Party) : FlowLogic<SignedTransaction>() {
    ...
    override fun call(): SignedTransaction {
        ...
        val terrainTypes: Array<HexTileType> = arrayOf(
                HexTileType.Forest, HexTileType.Pasture, HexTileType.Field,
                HexTileType.Hill, HexTileType.Mountain, HexTileType.Desert)
        ...
        for (i in 0..18) {
            ...
            hexTiles.add(i, HexTile(
                    hexType,
                    if (hexType == HexTileType.Desert) 0 else roleTriggerTilePlacementMapping.getOrElse(roleTriggerTilePlacementOrder[i - desertSkippedIndexAdjustment]) { 0 },
                    terrainTypes[hexTypeIndex] == HexTileType.Desert,
                    i))
        ...
        val hexTileWithDesert = hexTiles.filter { it.resourceType == HexTileType.Desert }.single()
