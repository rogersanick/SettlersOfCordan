...
class BuildRoadFlow(val gameBoardLinearId: UniqueIdentifier, val hexTileIndex: Int, val hexTileSide: Int): FlowLogic<SignedTransaction>() {
    ...
    override fun call(): SignedTransaction {
        ...
        val buildSettlement = Command(BuildPhaseContract.Commands.BuildRoad(), gameBoardState.players.map { it.owningKey })
        ...
        // TODO: Determine which roads this new road state extends (if any)
