...
//
//    driver(DriverParameters(cordappsForAllNodes = listOf(TestCordapp.findCordapp("com.flows"), TestCordapp.findCordapp("com.statesAndContracts"), TestCordapp.findCordapp( "com.flows")), startNodesInProcess = true, waitForAllNodesToFinish = true)) {
