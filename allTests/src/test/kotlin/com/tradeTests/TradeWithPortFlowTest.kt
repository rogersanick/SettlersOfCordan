...
class TradeWithPortFlowTest {
    ...
    fun player1IsAbleToMakeMultipleTradesWithAPortOnTheirTurn() {
        ...
        val inputResource = portToTradeWith.portTile.inputRequired.filter { it.token.tokenClass == Resource.getInstance(gameBoardState.hexTiles[0].resourceType.resourceYielded!!).tokenClass }.first().token
